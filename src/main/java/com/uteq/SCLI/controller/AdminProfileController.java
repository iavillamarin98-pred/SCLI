...
public class AdminProfileController {
  ...
  public AdminProfileController(ProfileService svc, JdbcTemplate jdbc) {
    this.svc = svc;
    this.jdbc = jdbc;
  }

  /* ===== Helpers de sesión (mismos que coordinador) ===== */
  ...
  public String viewPerfil(Model model, HttpSession session, HttpServletRequest req){
    ...
    return "dashboard/admin/admin-perfil";
  }
  ...
  public String savePerfil(@ModelAttribute("perfil") ProfileDTO dto,
    ...
    try{
      ...
      log.error("Error guardando perfil admin", e);
  ...
  public String viewClave(){
    return "dashboard/admin/admin-cambio-clave";
  }
